...
class PasswordField(forms.CharField):
    def __init__(self, *args, **kwargs):
        ...
        kwargs["widget"] = forms.PasswordInput(
            ...
            attrs={
                "placeholder": placeholder if placeholder is not None else kwargs.get("label"),
                "class": css_class,
...
class SetPasswordField(PasswordField):
    def __init__(self, *args, **kwargs):
        kwargs["autocomplete"] = kwargs.get("autocomplete", "new-password")
        kwargs.setdefault(
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["password1"] = SetPasswordField(
            label=_("Password"),
            placeholder=_('Enter your password...'),
            css_class='form-control',
            data_sb_validations='required,password'
        ...
        if app_settings.SIGNUP_PASSWORD_ENTER_TWICE:
            self.fields["password2"] = SetPasswordField(
                label=_("Password (again)"),
                placeholder=_('Confirm your password...'),
                css_class='form-control',
                data_sb_validations='required,password'
...
class AddEmailForm(forms.Form):
    email = forms.EmailField(
        ...
        required=True,
        widget=forms.TextInput(
            attrs={"type": "email", "placeholder": _("Email address"), "class": "form-control", "data-sb-validations": "required,email"}
        ),
    )
